...
import com.ynwlzc.framework.cyberwinosand_PCScreenManager.R;
...
public class CaptureManager {
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(final BarcodeResult result) {
           ...
           // Cyber_JsPrinterStandard.cyber_scan_result=result.getText();
        }
    ...
    public void 未来之窗扫码_解码(BarcodeCallback 未来之窗扫码callback) {
        barcodeView.decodeSingle(未来之窗扫码callback);
    }
